...
public class ApplicationView extends ActionBarActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
          ...
          TextView titulo = (TextView) findViewById(R.id.titulo_vistaaplic);          
      	  ...
      	  ImageView imageView = (ImageView) findViewById(R.id.imagen_vistaaplic);
      	  Bitmap bm = BitmapFactory.decodeResource(getResources(), R.drawable.imagen);
   		  imageView.setImageBitmap(ImageHelper.getRoundedCornerBitmap(bm, 12, ApplicationView.this));
      	  
    	
      	  new DownloadApplicationsImage(imageUrl).start();
	...
	public void loadImage(final Bitmap bm){
		runOnUiThread(new Runnable() {
	        public void run() {
	        	ImageView imageView = (ImageView) findViewById(R.id.imagen_vistaaplic);
	        	if (bm != null) imageView.setImageBitmap(ImageHelper.getRoundedCornerBitmap(bm, 12, ApplicationView.this));
	        	else {
	        		Bitmap bm = BitmapFactory.decodeResource(getResources(), R.drawable.imagen);
		   		 	imageView.setImageBitmap(ImageHelper.getRoundedCornerBitmap(bm, 12, ApplicationView.this));
	        	}	        	
    ...
    class DownloadApplicationsImage extends Thread {
       	String url;
       	
       	public DownloadApplicationsImage(String Url){
       		url = Url;
       	}
