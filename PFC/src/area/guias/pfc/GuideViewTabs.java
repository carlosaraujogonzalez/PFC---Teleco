...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void copiar(View view){
		new Funciones().showToast(this, "Método disponible próximamente");
		/*Dialog dialog = create_copy_guide_dialog("Advertencia", "¿Quieres copiar esta guía?"); 	
		dialog.show();*/
    }
	...
	public void copy_technical_setting(View viw){
		Dialog dialog = create_copy_technical_setting_dialog("Advertencia", "¿Quieres copiar un contexto técnico de la biblioteca?");		
		dialog.show();
	}
	...
	public void create_technical_setting(View view){
		Dialog dialog = create_technical_setting_dialog("Advertencia", "Quieres crear un nuevo contexto técnico?");
		dialog.show();
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	class GetDuplicate extends AsyncTask<Void, Void, Void> {
        protected Void doInBackground(Void... empty) {       	
            	...
            	try {
					...
					Looper.prepare();
            			Dialog dialog = new Funciones().create_ok_dialog(GuideViewTabs.this, "Advertencia", "La guía ha sido copiada");
            			dialog.show();
            		Looper.loop();
    ...
    class RemoveGuide extends Thread {
        ...
        public void run() {
			...
			Looper.prepare();
    			Dialog dialog = create_finish_dialog(GuideViewTabs.this, "Advertencia", "La guía ha sido eliminada");
    			dialog.show();
    		Looper.loop();
	...
	class SendHeader extends Thread {
        ...
        public void run() {        	
			try {
				...
				System.out.println(BaseUrlPage);
            	System.out.println("Datos enviados: ");
            	Log.d("", "título: " + header.title); 
            	System.out.println("Descripción: "+header.description);
	...
	class SendTechnicalSetting extends Thread {
        ...
        public void run() {
			...
			try {
				...
				Looper.prepare();
            	new Funciones().showToast(GuideViewTabs.this, "contexto técnico guardado");
            	Looper.loop();
